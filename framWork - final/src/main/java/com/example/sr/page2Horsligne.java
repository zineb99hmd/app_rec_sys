...
public class page2Horsligne implements Initializable {
    ...
    void choix_File_item( MouseEvent MOUSE_CLICKED){
        ...
        if ((itemfield.getText().length()!=0)&&(eventfield.getText().length()!=0)) {
    ...
    void test(ActionEvent event){
        ...
        if ((itemfield.getText().length()==0)&&(eventfield.getText().length()==0)) {
            itemfield.setStyle("-fx-border-color:red ; -fx-border-width:2px ");
            new animatefx.animation.Shake(itemfield).play();
            eventfield.setStyle("-fx-border-color:red ; -fx-border-width:2px ");
            new animatefx.animation.Shake(eventfield).play();
            ...
            if (itemfield.getText().length() == 0) {
                ...
                if (eventfield.getText().length() == 0) {
                    ...
                    itemfield.setStyle("-fx-border-color:green; -fx-border-width:2px ");
                    new animatefx.animation.Shake(itemfield).play();
                    eventfield.setStyle("-fx-border-color:green ; -fx-border-width:2px ");
                    new animatefx.animation.Shake(eventfield).play();
